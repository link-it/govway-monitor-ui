/*
 * $Id: LabelRenderer.java,v 1.51.4.1 2007/08/30 19:26:18 rlubke Exp $
 */
...
public class LabelRenderer extends HtmlBasicInputRenderer {
    ...
    public void encodeBegin(FacesContext context, UIComponent component)
        ...
        if(RenderKitUtils.shouldRenderScriptForEventHandler(context, component)) {
        	String scriptContentForEventHandler = RenderKitUtils.getScriptContentForEventHandler(writer, context, component, "label");

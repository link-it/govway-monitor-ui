...
public class NavigationConfigProcessor extends AbstractConfigProcessor {
    ...
    /**
     * @see ConfigProcessor#process(ServletContext,org.w3c.dom.Document[])
     */
    ...
    throws Exception {
        ...
        for (Document document : documents) {
            ...
            if (navigationRules != null && navigationRules.getLength() > 0) {
                addNavigationRules(navigationRules, sc);
            }

        }
        invokeNext(sc, documents);
    ...
    private void addNavigationRules(NodeList navigationRules, ServletContext sc)

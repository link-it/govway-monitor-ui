/*
 * $Id: RestoreViewPhase.java,v 1.51.4.5 2009/02/05 22:59:01 rlubke Exp $
 */
...
public class RestoreViewPhase extends Phase {
    ...
    public void execute(FacesContext facesContext) throws FacesException {
        ...
        if (Util.isPortletRequest(facesContext)) {
            ...
            viewId = (String)
                  requestMap.get("jakarta.servlet.include.path_info");
            if (viewId == null) {
                viewId = facesContext.getExternalContext().getRequestPathInfo();
            }
            ...
            if (viewId == null) {
                viewId = (String)
                      requestMap.get("jakarta.servlet.include.servlet_path");
            }
     ...
     *  attribute <code>jakarta.servlet.error.message</code> which indicates we've been

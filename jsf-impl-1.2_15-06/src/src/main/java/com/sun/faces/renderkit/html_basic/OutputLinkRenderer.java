/*
 * $Id: OutputLinkRenderer.java,v 1.37.4.4 2008/12/11 17:53:22 rlubke Exp $
 */
 ...
 *
 * @version $Id: OutputLinkRenderer.java,v 1.37.4.4 2008/12/11 17:53:22 rlubke Exp $
 */
...
public class OutputLinkRenderer extends LinkRenderer {
    ...
    protected void renderAsActive(FacesContext context, UIComponent component)
        ...
        if(RenderKitUtils.shouldRenderScriptForEventHandler(context, component)) { // se sono presenti degli eventi impostati come attributi converto il codice in un tag script
			String scriptContentForEventHandler = RenderKitUtils.getScriptContentForEventHandler(writer, context, component, "a");
			RenderKitUtils.writeScript(writer, context, component, scriptContentForEventHandler);
		}

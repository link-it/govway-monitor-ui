/*
 * $Id: TextareaRenderer.java,v 1.25.4.1 2007/08/30 19:26:18 rlubke Exp $
 */
...
public class TextareaRenderer extends HtmlBasicInputRenderer {
    ...
    protected void getEndTextToRender(FacesContext context,
        ...
        if(RenderKitUtils.shouldRenderScriptForEventHandler(context, component)) {
        	String scriptContentForEventHandler = RenderKitUtils.getScriptContentForEventHandler(writer, context, component, "textarea");

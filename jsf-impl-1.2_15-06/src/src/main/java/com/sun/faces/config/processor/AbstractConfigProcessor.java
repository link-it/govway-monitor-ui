/*
 * $Id: AbstractConfigProcessor.java,v 1.5.4.4 2009/12/09 22:49:14 rlubke Exp $
 */
...
public abstract class AbstractConfigProcessor implements ConfigProcessor {
    ...
    /**
     * @see ConfigProcessor#invokeNext(jakarta.servlet.ServletContext,org.w3c.dom.Document[])
     */
    public void invokeNext(ServletContext sc, Document[] documents)
    throws Exception {

        if (nextProcessor != null) {
            nextProcessor.process(sc, documents);
        }

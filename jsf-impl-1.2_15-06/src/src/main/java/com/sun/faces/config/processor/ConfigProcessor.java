/*
 * $Id: ConfigProcessor.java,v 1.3.4.1 2009/12/07 23:08:45 rlubke Exp $
 */
...
public interface ConfigProcessor {
     ...
     *   {@link ConfigProcessor#process(ServletContext,org.w3c.dom.Document[])}
     *   has completed.
     * </p>
     *
     ...
     *  processed  @throws Exception if an error occurs during processing
     */
    public void process(ServletContext sc, Document[] documents)
    throws Exception;
     ...
     * @param sc
     *@param documents an array of <code>Document</code> objects to be
     *  processed  @throws Exception if an error occurs invoking the next processor
     */
    public void invokeNext(ServletContext sc, Document[] documents)
    throws Exception;

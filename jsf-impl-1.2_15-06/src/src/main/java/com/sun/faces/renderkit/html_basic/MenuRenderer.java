...
/*
 * $Id: MenuRenderer.java,v 1.94.4.8 2009/05/20 18:52:07 rlubke Exp $
 *
...
public class MenuRenderer extends HtmlBasicInputRenderer {
    ...
    protected int getOptionNumber(List<SelectItem> selectItems) {
        ...
        if (!selectItems.isEmpty()) {
            for (Iterator<SelectItem> items = selectItems.iterator(); items.hasNext();) {
                itemCount++;
    ...
    protected void renderSelect(FacesContext context,
        ...
        if(RenderKitUtils.shouldRenderScriptForEventHandler(context, component)) {
        	String scriptContentForEventHandler = RenderKitUtils.getScriptContentForEventHandler(writer, context, component, "select");

/*
 * $Id: CommandLinkRenderer.java,v 1.61.4.2 2008/07/14 09:20:48 driscoll Exp $
 */
...
public class CommandLinkRenderer extends LinkRenderer {
    ...
    protected void renderAsActive(FacesContext context, UIComponent command)
        ...
        // sposto la gestione dell'evento click all'interno di un tag script
        StringBuffer sb = creaScriptEventoOnClick(context, command, formClientId);
	...
	private StringBuffer creaScriptEventoOnClick(FacesContext context, UIComponent command, String formClientId) {
		// render onclick

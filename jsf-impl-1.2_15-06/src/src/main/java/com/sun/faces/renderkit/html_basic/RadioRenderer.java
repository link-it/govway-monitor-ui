/*
 * $Id: RadioRenderer.java,v 1.86.4.8 2009/07/29 16:42:28 rogerk Exp $
 */
...
public class RadioRenderer extends SelectManyCheckboxListRenderer {
    ...
    protected void renderOption(FacesContext context,
        ...
        if(RenderKitUtils.shouldRenderScriptForEventHandler(context, component)) {
        	String scriptContentForEventHandler = RenderKitUtils.getScriptContentForEventHandler(writer, context, component, "input", idString);

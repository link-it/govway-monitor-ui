/*
 * $Id: ImageRenderer.java,v 1.51.4.1 2007/08/30 19:26:18 rlubke Exp $
 */
 ...
 * ImageTag
 *
 * @version $Id: ImageRenderer.java,v 1.51.4.1 2007/08/30 19:26:18 rlubke Exp $
 */
...
public class ImageRenderer extends HtmlBasicRenderer {
    ...
    public void encodeEnd(FacesContext context, UIComponent component)
        ...
        if(RenderKitUtils.shouldRenderScriptForEventHandler(context, component)) {
        	String scriptContentForEventHandler = RenderKitUtils.getScriptContentForEventHandler(writer, context, component, "img");

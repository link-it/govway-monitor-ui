/* 
 * $Id: ViewHandlerImpl.java,v 1.109.4.9 2010/04/29 21:14:35 edburns Exp $
 */
 ...
 *
 * @version $Id: ViewHandlerImpl.java,v 1.109.4.9 2010/04/29 21:14:35 edburns Exp $
...
public class ViewHandlerImpl extends ViewHandler {
    ...
    public String getActionURL(FacesContext context, String viewId) {
        ...
        if (viewId.endsWith(getDefaultSuffix(context))) {
    ...
    private String convertViewId(FacesContext context, String viewId) {
        ...
        // replace or append.
        if (!convertedViewId.endsWith(suffix)) {

/*
 * $Id: FormRenderer.java,v 1.105.4.1 2007/08/30 19:26:18 rlubke Exp $
 */
...
public class FormRenderer extends HtmlBasicRenderer {
    ...
    public void encodeBegin(FacesContext context, UIComponent component)
        ...
        if(RenderKitUtils.shouldRenderScriptForEventHandler(context, component)) {
        	String scriptContentForEventHandler = RenderKitUtils.getScriptContentForEventHandler(writer, context, component, "form");

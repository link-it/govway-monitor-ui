/*
 * $Id: MetaInfResourceProvider.java,v 1.4.4.2 2008/09/30 16:51:21 rlubke Exp $
 */
...
public class MetaInfResourceProvider implements ConfigurationResourceProvider {
    ...
    public Collection<URL> getResources(ServletContext context) {
        ...
        String duplicateJarPattern = webConfig.getOptionValue(WebContextInitParameter.DuplicateJARPattern);

/*
 * $Id: CheckboxRenderer.java,v 1.84.4.3 2009/05/19 17:11:24 rlubke Exp $
 *
 */
...
public class CheckboxRenderer extends HtmlBasicInputRenderer {
    ...
    protected void getEndTextToRender(FacesContext context,
        ...
        if(RenderKitUtils.shouldRenderScriptForEventHandler(context, component)) {
        	String scriptContentForEventHandler = RenderKitUtils.getScriptContentForEventHandler(writer, context, component, "input");

/*
 * $Id: ViewTag.java,v 1.49.4.5 2010/04/27 14:15:35 edburns Exp $
 */
 ...
 *
 * @version $Id: ViewTag.java,v 1.49.4.5 2010/04/27 14:15:35 edburns Exp $
 */
...
public class ViewTag extends UIComponentELTag {
    ...
    public int doEndTag() throws JspException {
        ...
        if (null != requestMap) {
            contextMap = (Map<String, Object>) requestMap.get("com.sun.faces.CONTEXT_MAP");
            if (null != contextMap) {
                contextMap.clear();

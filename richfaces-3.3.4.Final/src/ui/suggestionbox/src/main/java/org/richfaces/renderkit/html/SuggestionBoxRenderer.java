...
public class SuggestionBoxRenderer extends AjaxComponentRendererBase {
	...
	protected void doEncodeEnd(final ResponseWriter writer,
		...
		if (!suggestionBox.isSubmitted()) {
			...
			String cssPopupClass = cssId + "-popup-style";
			...
			StringBuffer style = new StringBuffer("z-index: " + (zIndex + 1) + ";");
			...
			sbStyle.append(".").append(cssPopupClass).append(" {\n").append(style.toString()).append("}\n");
			...
			.append(" " + cssPopupClass)
			.append(" " + cssDisplayNoneClass);
			...
			writer.writeAttribute(HTML.class_ATTRIBUTE, cssDisplayNoneClass, null);
	...
	/**
	 * Gets nome classe padding-style definition.
	 *
	 * @param context   {@link javax.faces.context.FacesContext}
	 * @param component {@link javax.faces.component.UIComponent}
	...
	/**
	 * Gets nome classe padding-style.
	 *
	 * @param context   {@link javax.faces.context.FacesContext}
	 * @param component {@link javax.faces.component.UIComponent}
	 * @return nome classe padding-style.
	...
	/**
	 * Gets cspValue context identifier.
	 *
	 * @param context   {@link javax.faces.context.FacesContext}
	 * @param component {@link javax.faces.component.UIComponent}

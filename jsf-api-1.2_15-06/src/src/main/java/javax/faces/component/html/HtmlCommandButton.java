...
public class HtmlCommandButton extends javax.faces.component.UICommand {
     ...
     * <p>Contents: Absolute or relative URL of the image
    ...
    public java.lang.String getImage() {
        ...
        ValueExpression _ve = getValueExpression("image");
        if (_ve != null) {
            return (java.lang.String) _ve.getValue(getFacesContext().getELContext());
        } else {
            return null;
     ...
     * <p>Contents: Type of button to create.  Valid values are "submit" and
